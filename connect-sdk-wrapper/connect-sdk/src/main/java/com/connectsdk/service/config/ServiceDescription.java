...
public class ServiceDescription implements Cloneable {
    ...
    public ServiceDescription(JSONObject json) {
        ...
        wifiMac = json.optString(KEY_WIFI_MAC, null);
    }
    ...
    public JSONObject toJSONObject() {
        ...
        try {
            ...
            jsonObj.putOpt(KEY_WIFI_MAC, wifiMac);
    ...
    public ServiceDescription clone() {
        ...
        try {
            service.setServiceURI(this.serviceURI);
        ...
        try {
            service.setWifiMac(this.wifiMac);
        } catch (NullPointerException ex) {
        }
    ...
    public boolean equals(Object o) {
        if (o instanceof ServiceDescription) {
            ServiceDescription description = (ServiceDescription) o;
            return description.getUUID().equals(getUUID())
                    && description.getIpAddress().equals(getIpAddress());
        }
        return false;
    }
}
