...
public class MultiScreenWebAppSession extends WebAppSession {
    ...
    public static final String LOG_TAG = "MultiScreen";
    ...
    private IChannelListener channelListener = new IChannelListener() {
        ...
        public void onClientDisconnected(ChannelClient client) {
            SmartLog.d(LOG_TAG, "onClientDisconnected, client " + client.getId());
            // TODO Auto-generated method stub
        ...
        public void onClientConnected(ChannelClient client) {
            SmartLog.d(LOG_TAG, "onClientConnected " + client.getId());
            // TODO Auto-generated method stub
    ...
    public void handleMediaEvent(JSONObject payload) {
        SmartLog.i(LOG_TAG, "handleMediaEvent " + payload);
    ...
    public void handleMediaCommandResponse(JSONObject payload) {
        SmartLog.i(LOG_TAG, "handleMediaCommandResponse " + payload);
    ...
    public void connect(final ResponseListener<Object> listener) {
        SmartLog.i(LOG_TAG, "connect ");
        if (service == null || service.getDevice() == null) {
            if (listener != null) {
                SmartLog.e(LOG_TAG, "You can only connect to a valid WebAppSession object.");
        ...
        SmartLog.d(LOG_TAG, "connectToChannel " + channelId);
    ...
    public void join(final ResponseListener<Object> listener) {
        ...
        if (application != null) {
            ...
            SmartLog.d(LOG_TAG, "app connection without application object should not be allowed to happen! ");
            connect(listener);
        }
    }
    ...
    public void sendMessage(String message, ResponseListener<Object> listener) {
        SmartLog.i(LOG_TAG, "sendMessage ");
    ...
    public void disconnectFromWebApp() {
        SmartLog.i(LOG_TAG, "disconnectFromWebApp ");
        if (mChannel == null) {
            SmartLog.e(LOG_TAG, "Channel is null! Cannot disconnect ");
            return;
        }
...
//	        // This is a hack to enable closing of bridged web apps that we didn't open
    ...
    public ServiceSubscription<PlayStateListener> subscribePlayState(PlayStateListener listener) {
        if (playStateSubscription == null) {
            playStateSubscription = new URLServiceSubscription<PlayStateListener>(null, null, null, null);
        }
