...
public class ServiceCommandError extends Error {
    ...
    public static final int MEDIA_UNSUPPORTED = 600;
    public static final int RECEIVER_APP_NOT_INSTALLED = 601;
    public static final int FIRE_TV_NEEDS_REBOOT = 701;
    ...
    public static ServiceCommandError getError(int code) {
        ...
        } else if (code == MEDIA_UNSUPPORTED) {
            desc = "Media type is not supported!";
        } else if (code == RECEIVER_APP_NOT_INSTALLED) {
            desc = "Receiver application was not found";
        } else if (code == FIRE_TV_NEEDS_REBOOT) {
            desc = "Internal error in the Fire TV media player. If the issue is not resolved by the second time you played this file, try to reboot the Fire TV stick instead.";
        } else {
            desc = "Unknown Error";
        }
