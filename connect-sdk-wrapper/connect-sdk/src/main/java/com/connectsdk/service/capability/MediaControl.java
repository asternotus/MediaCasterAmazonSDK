...
public interface MediaControl extends CapabilityMethods {
    ...
    void showProgressScreen(ResponseListener<Object> responseListener);

    void hideProgressScreen(ResponseListener<Object> responseListener);
    ...
    public enum PlayStateStatus {
        /**
         * Unsupported format error (runtime)
         */
        ...
        /**
         * Playback was cancelled on TV side
         */
        Cancelled,
