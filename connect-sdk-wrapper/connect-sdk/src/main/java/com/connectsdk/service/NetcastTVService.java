...
public class NetcastTVService extends DeviceService implements Launcher, MediaControl, MediaPlayer, TVControl, VolumeControl, ExternalInputControl, MouseControl, TextInputControl, PowerControl, KeyControl {
    ...
    public void connect() {
        if (state != State.INITIAL) {
            SmartLog.w(Util.T, "already connecting; not trying to connect again: " + state);
...
//        mServiceReachability.start();
    ...
    public void launchBrowser(String url, final Launcher.AppLaunchListener listener) {
        if (!(url == null || url.length() == 0))
            SmartLog.w(Util.T, "Netcast TV does not support deeplink for Browser");
    ...
    public void unSubscribePlayState(PlayStateListener listener) {
        if (getDLNAService() != null) {
            getDLNAService().unSubscribePlayState(listener);
        } else Util.postError(listener, ServiceCommandError.notSupported());
    }
    ...
    public void connectMouse() {
        ResponseListener<Object> listener = new ResponseListener<Object>() {
            ...
            @Override
            public void onSuccess(Object response) {
                SmartLog.d(Util.T, "Netcast TV's mouse has been connected");
            ...
            @Override
            public void onError(ServiceCommandError error) {
                SmartLog.w(Util.T, "Netcast TV's mouse connection has been failed");
            }
        };
    ...
    public void click() {
        ResponseListener<Object> responseListener = new ResponseListener<Object>() {
            ...
            @Override
            public void onError(ServiceCommandError error) {
                SmartLog.w(Util.T, "Netcast TV's mouse click has been failed");
            }
        };
    ...
    private void moveMouse() {
        ...
        ResponseListener<Object> responseListener = new ResponseListener<Object>() {
            ...
            @Override
            public void onError(ServiceCommandError error) {
                SmartLog.w(Util.T, "Netcast TV's mouse move has failed");
    ...
    public void scroll(double dx, double dy) {
        ResponseListener<Object> responseListener = new ResponseListener<Object>() {
            ...
            @Override
            public void onError(ServiceCommandError error) {
                SmartLog.w(Util.T, "Netcast TV's mouse scroll has been failed");
            }
        };
    ...
    public void sendText(final String input) {
        SmartLog.d(Util.T, "Add to Queue: " + input);
    ...
    public void sendEnter() {
        ...
        ResponseListener<Object> responseListener = new ResponseListener<Object>() {
            ...
            @Override
            public void onError(ServiceCommandError error) {
                SmartLog.w(Util.T, "Netcast TV's enter key has been failed");
            }
        };
    ...
    private void handleKeyboardInput(final String state, final String buffer) {
        ResponseListener<Object> responseListener = new ResponseListener<Object>() {
            ...
            @Override
            public void onError(ServiceCommandError error) {
                SmartLog.w(Util.T, "Netcast TV's keyboard input has been failed");
            }
        };
    ...
    public void powerOff(ResponseListener<Object> listener) {
        ResponseListener<Object> responseListener = new ResponseListener<Object>() {
            ...
            @Override
            public void onError(ServiceCommandError error) {
                SmartLog.w(Util.T, "Netcast TV's power off has been failed");
            }
        };
