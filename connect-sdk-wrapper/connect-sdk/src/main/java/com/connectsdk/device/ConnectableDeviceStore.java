...
public interface ConnectableDeviceStore {
    ...
    /**
     * A JSONObject of all ConnectableDevices in the ConnectableDeviceStore. To gt a strongly-typed ConnectableDevice object, use the `getNsDevice(String);` method.
     */
