...
public class CastDiscoveryProvider implements DiscoveryProvider {
    private static final String LOG_TAG = CastDiscoveryProvider.class.getSimpleName();

    private static final long ROUTE_REMOVE_INTERVAL = 3000;
    public static final String CATEGORY_REMOTE_PLAYBACK = "CATEGORY_REMOTE_PLAYBACK";
    ...
    public void start() {
        ...
        if (mMediaRouteSelector == null) {
            try {
                if (!TextUtils.isEmpty(applicationId) && applicationId.equals(CATEGORY_REMOTE_PLAYBACK)) {
                    SmartLog.d(LOG_TAG, "MediaControlIntent.CATEGORY_REMOTE_PLAYBACK " + MediaControlIntent.CATEGORY_REMOTE_PLAYBACK);
                    mMediaRouteSelector = new MediaRouteSelector.Builder()
                            .addControlCategory(MediaControlIntent.CATEGORY_REMOTE_PLAYBACK)
                            .build();
                } else {
                    if (TextUtils.isEmpty(applicationId)) {
                        applicationId = CastService.getApplicationID();
                    }
                    SmartLog.d(LOG_TAG, "start discovery " + applicationId);
                    mMediaRouteSelector = new MediaRouteSelector.Builder()
                ...
                SmartLog.w(Util.T, "Invalid application ID: " + CastService.getApplicationID());
    ...
    private class MediaRouterCallback extends MediaRouter.Callback {
        ...
        public void onRouteAdded(MediaRouter router, RouteInfo route) {
            ...
            SmartLog.d(LOG_TAG, "onRouteAdded " + route.toString());
        ...
        public void onRouteChanged(MediaRouter router, RouteInfo route) {
            ...
            SmartLog.d(LOG_TAG, "onRouteChanged " + route.toString());
            ...
            SmartLog.d(LOG_TAG, "onRouteChanged " + isNew);
        ...
        public void onRoutePresentationDisplayChanged(MediaRouter router,
                                                      RouteInfo route) {
            SmartLog.d(Util.T, "onRoutePresentationDisplayChanged: [" + route.getName() + "] ["
        ...
        public void onRouteRemoved(final MediaRouter router, final RouteInfo route) {
            ...
            SmartLog.d(LOG_TAG, "onRouteRemoved " + route.toString());
        ...
        public void onRouteVolumeChanged(MediaRouter router, RouteInfo route) {
            SmartLog.d(Util.T, "onRouteVolumeChanged: [" + route.getName() + "] ["
                    + route.getDescription() + "]");
        ...
        private void removeServices(RouteInfo route) {
            for (String uuid : removedUUID) {
                ...
                if (service != null) {
                    SmartLog.d(Util.T, "Service [" + route.getName() + "] has been removed");
                    Util.runOnUI(new Runnable() {
